    ...
    public class HandToolsViewModel:BaseViewModel
    {
        ...
        private void LoadProducts()
        {
            try
            {
                ...
                // Find Hand Tools subcategory
                var handToolsSubcategory = toolsCategory.Subcategories
                    .FirstOrDefault(sc => sc.Name == "Hand Tools");
                ...
                // Log hand tools details
                System.Diagnostics.Debug.WriteLine($"Total Hand Tools: {handTools.Count}");
